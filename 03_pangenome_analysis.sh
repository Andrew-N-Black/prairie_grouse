...
FINAL_DIR="${PROJECT_DIR}/final"          # input: from 02_genome_assembly_array.sh
...
if [[ "$N_HAPS" -lt 2 ]]; then
    ...
    echo "Check that 02_genome_assembly_array.sh has completed for at least one sample."
    exit 1
fi
